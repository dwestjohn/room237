...
function MenuPage() {
  ...
  return (
    <div className="container">
      ...
      {/* Top Shelf */}
      <h2 className="section-title section-spacer">Top Shelf Sippers</h2>
      ...
      {/* Seltzer */}
      <h2 className="section-title section-spacer">Seltzer</h2>
      <div className="beer-row">
      ...
      {selectedRecipe ? (
        ...
        <p style={{ textAlign: 'center', color: 'gray' }}>
          Select a drink above to place an order.
        </p>
      )}
